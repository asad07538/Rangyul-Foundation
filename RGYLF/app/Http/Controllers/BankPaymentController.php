...
class BankPaymentController extends Controller
{
    ...
    {
        //
        $accEntries=AccEntry::where('entry_type',1)->get();
        return view('account.entries.bank_payment.index',compact('accEntries'));
    }
    ...
    public function create()
    {
        ...
        $accLedgers_from=AccLedger::where('is_bank_cash',1)->get();
        $accLedgers_to=AccLedger::where('is_bank_cash','!=',1)->get();
