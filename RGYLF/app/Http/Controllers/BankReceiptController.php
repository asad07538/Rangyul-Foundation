...
class BankReceiptController extends Controller
{
    ...
    {
        //
        $accEntries=AccEntry::where('entry_type',2)->get();
        return view('account.entries.bank_receipt.index',compact('accEntries'));
    }
    ...
    public function create()
    {
        ...
        $accLedgers_to = AccLedger::where('is_bank_cash',2)->get();
        $accLedgers_from = AccLedger::where('is_bank_cash','!=',2)->get();
        // dd($accLedgers_from);
        $accEntryType_id=2;
