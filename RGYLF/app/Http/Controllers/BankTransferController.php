...
class BankTransferController extends Controller
{
    ...
    {
        //
        $accEntries=AccEntry::where('entry_type',6)->get();
        return view('account.entries.bank_transfer.index',compact('accEntries'));
    }
    ...
    public function create()
    {
        ...
        $accLedgers_to = AccLedger::where('is_bank_cash',6)->get();
        $accLedgers_from = AccLedger::where('is_bank_cash','!=',6)->get();
        // dd($accLedgers_from);
        $accEntryType_id=6;
