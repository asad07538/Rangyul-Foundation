@extends('admin_layout.app', ['title' => 'Bank Payment'])
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="text-right">
            <a href="{{ route('account_bank_payment.create') }}" class="btn btn-primary btn-sm"><i class="fa fa-plus">Add New</i></a>
        </div>
