@extends('admin_layout.app', ['title' => 'Bank Transfer'])
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="text-right">
            <a href="{{ route('account_bank_transfer.create') }}" class="btn btn-primary btn-sm"><i class="fa fa-plus">Add New</i></a>
        </div>
