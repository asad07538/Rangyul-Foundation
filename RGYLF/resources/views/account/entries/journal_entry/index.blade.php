@extends('admin_layout.app', ['title' => 'Journal Entry'])
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="text-right">
            <a href="{{ route('account_journal_entry.create') }}" class="btn btn-primary btn-sm"><i class="fa fa-plus">Add New</i></a>
        </div>
