...
@section('content-header')
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">New Fund Collection</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
...
@section('content')
    ...
    <section class="content">
      <div class="container-fluid">
        <form method="POST" action="{{ route('fund_collection.store') }}">
            @csrf
                                ...
                                <td>
                                    <select name="ledger_id[]" id="ledger_id_1"  class="form-control  chzn hidden chzn-done">
                                        ...
                                        @foreach($donars as $donar)
                                          <option value="{{$donar->ledger->id}}">{{$donar->ledger->acc_code }}({{$donar->ledger->name}})</option>
                                        @endforeach
                                    </select>
                                </td>
